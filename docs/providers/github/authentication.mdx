...
read:org        # Required to list your organization teams
```

:::caution

Beware that if you don't set correct permissions for your token, you won't see any errors and all resources will appear as deleted from remote.
